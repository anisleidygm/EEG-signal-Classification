%% Script to load and put all the healthy empirical EEG data in a single folder.
% Only the Oz channel was extracted since correspond to occipital activity,
% mainly associated with alpha rhythms, charactristic in healthy
% subjects.The time vector associated to each signal was also saved

%% ------------------
% Set the path to the main EEG1 and EEG2 folders
mainFolder = 'D:\OneDrive - CCLAB\Postdoc\Draft\IJCAI 2025\Real Data\EEG1';
